...
public class PolygonToPolygonTestingSet2 : Game
{
    ...
    protected override void Initialize()
    {
        ...
        cola3_1.SetStatic(true);

        cola4_1 = new PolygonCollider(new Vector2(700, 100), squarePointFList);
        ...
        cola4_1.SetStatic(true);

        cola5_1 = new PolygonCollider(new Vector2(900, 100), squarePointFList);
        collisionSystem.AddCollisionObject(cola5_1);
        cola5_2 = new PolygonCollider(new Vector2(900, 40), squarePointFList);
        collisionSystem.AddCollisionObject(cola5_2);
        cola5_1.SetStatic(true);

        cola6_1 = new PolygonCollider(new Vector2(1100, 100), squarePointFList);
        collisionSystem.AddCollisionObject(cola6_1);
        cola6_2 = new PolygonCollider(new Vector2(1160, 40), squarePointFList);
        collisionSystem.AddCollisionObject(cola6_2);
        cola6_1.SetStatic(true);

        cola7_1 = new PolygonCollider(new Vector2(1300, 100), squarePointFList);
        collisionSystem.AddCollisionObject(cola7_1);
        cola7_2 = new PolygonCollider(new Vector2(1360, 100), squarePointFList);
        collisionSystem.AddCollisionObject(cola7_2);
        cola7_1.SetStatic(true);
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        cola4_2.SetVelocity(new Vector2(0.2f, 0.2f));
        cola5_2.SetVelocity(new Vector2(0, 0.2f));
        cola6_2.SetVelocity(new Vector2(-0.2f, 0.2f));
        cola7_2.SetVelocity(new Vector2(-0.2f, 0));
