...
//         PathfindingSearchNetwork pathfindingSearchNetwork = sc.AddBehaviour(map, new PathfindingSearchNetwork()) as PathfindingSearchNetwork;
//         Collider c0 = sc.AddBehaviour(map, new CircleCollider(230, "mapFloor", true)) as Collider;
//         c0.SetStatic(true);
//         sc.AddNodeAtRoot(map);
//
//         GenericNode map_col1 = new GenericNode();
//         Collider c1 = sc.AddBehaviour(map_col1, new CircleCollider(100, "mapFloor", true)) as Collider;
//         c1.SetStatic(true);
//         sc.AddNode(map, map_col1);
//         map_col1.SetLocalPosition(300, 300);
//
//         GenericNode map_col2 = new GenericNode();
//         Collider c2 = sc.AddBehaviour(map_col2, new CircleCollider(100, "mapFloor", true)) as Collider;
//         c2.SetStatic(true);
//         sc.AddNode(map, map_col2);
//         map_col2.SetLocalPosition(300, 160);
//
//         GenericNode map_col3 = new GenericNode();
//         Collider c3 = sc.AddBehaviour(map_col3, new CircleCollider(100, "mapWall", true)) as Collider;
//         c3.SetStatic(true);
