...
float4 MainPS(VertexShaderOutput input) : COLOR
{
    ...
    float2 translatedPos = lightPosition + translation; //perhaps use this to optimise and realize when light is offscreen by a lot? // position of light in screen space
